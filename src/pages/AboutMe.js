    ...
    return(
      <div className="container about-me">
        ...
        <wrapper className="lists row">
            ...
            <ul className="list2 col-md-3 col-sm-6 col-xs-6">
              <li>Express</li>
              <li>Knex</li>
              <li>PostgreSQL</li>
              <li>Git</li>
            ...
            <ul className="list3 col-md-3 col-sm-6 col-xs-6">
              <li>HTML</li>
              <li>CSS</li>
              <li>SCSS</li>
              <li>Gulp</li>
            ...
            <ul className="list4 col-md-3 col-sm-6 col-xs-6">
              <li>CLI</li>
              <li>Mongo</li>
              <li>Meteor</li>
