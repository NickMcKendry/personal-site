      ...
      <div className="container">
        ...
        <div className="row">
          <div className="well col-md-4">
            <h2><a href="https://sound-flick.firebaseapp.com/"><strong>Sound Flick</strong></a></h2>
          ...
          <div className="well col-md-4">
            <h2><a href="https://agile-overload.herokuapp.com/"><strong>Agile Overlod</strong></a></h2>
          ...
          <div className="well col-md-4">
            <h2><a href="https://yourspce.herokuapp.com/"><strong>YourSpace</strong></a></h2>
          ...
          <div className="well col-md-4">
            <h2><strong>Project 4</strong></h2>
          </div>
          <div className="well col-md-4">
            <h2><strong>Project 5</strong></h2>
          </div>
          <div className="well col-md-4">
            <h2><strong>Project 6</strong></h2>
          </div>
        </div>
      </div>
    )
